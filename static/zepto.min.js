var Zepto = function() {
    ...
    function U(t) {
        var e, n;
        return f[t] || (e = u.createElement(t),
    ...
    var t, e, n, i, P, N, r = [], o = r.concat, a = r.filter, s = r.slice, u = window.document, f = {}, c = {}, l = {
        "column-count": 1,
        columns: 1,
        "font-weight": 1,
        "line-height": 1,
        ...
        "z-index": 1,
        zoom: 1
    }, h = /^\s*<(\w+|!)[^>]*>/, p = /^<(\w+)\s*\/?>(?:<\/\1>|)$/, d = /<(?!area|br|col|embed|hr|img|input|link|meta|param)(([\w:]+)[^>]*)\/>/gi, m = /^(?:body|html)$/i, g = /([A-Z])/g, v = ["val", "css", "html", "text", "data", "width", "height", "offset"], y = ["after", "prepend", "before", "append"], x = u.createElement("table"), w = u.createElement("tr"), b = {
        ...
        th: w,
        "*": u.createElement("div")
    }, E = /complete|loaded|interactive/, T = /^[\w-]*$/, j = {}, S = j.toString, C = {}, O = u.createElement("div"), M = {
        tabindex: "tabIndex",
        readonly: "readOnly",
        "for": "htmlFor",
        "class": "className",
    ...
    C.fragment = function(e, i, r) {
        ...
        o || (e.replace && (e = e.replace(d, "<$1></$2>")),
        i === t && (i = h.test(e) && RegExp.$1),
        i in b || (i = "*"),
        f = b[i],
        f.innerHTML = "" + e,
    ...
    n.fn = {
        ...
        not: function(e) {
            ...
            if (A(e) && e.call !== t)
                ...
                var r = "string" == typeof e ? this.filter(e) : z(e) && A(e.item) ? s.call(e) : n(e);
            ...
            return "string" != typeof n || 1 in arguments ? this.each(function(t) {
                if (1 === this.nodeType)
                    if (R(n))
                        ...
                        W(this, n, J(this, i, t, this.getAttribute(n)))
        ...
        css: function(t, i) {
            if (arguments.length < 2) {
                ...
                "string" == typeof t)
                    return o.style[P(t)] || r.getPropertyValue(t);
                if (D(t)) {
                    var a = {};
            ...
            var s = "";
            if ("string" == L(t))
                i || 0 === i ? s = I(t) + ":" + H(t, i) : this.each(function() {
                    this.style.removeProperty(I(t))
                });
            else
                for (e in t)
                    t[e] || 0 === t[e] ? s += I(e) + ":" + H(e, t[e]) + ";" : this.each(function() {
    ...
    ["width", "height"].forEach(function(e) {
        ...
        n.fn[e] = function(r) {
            var o, a = this[0];
            return r === t ? Z(a) ? a["inner" + i] : $(a) ? a.documentElement["scroll" + i] : (o = this.offset()) && o[e] : this.each(function(t) {
                a = n(this),
                a.css(e, J(this, r, t, a[e]()))
            })
        }
    }),
...
function(t) {
    ...
    function C(e, n, i, r) {
        ...
        t.each(n, function(n, u) {
            ...
            !r && a ? e.add(u.name, u.value) : "array" == o || !i && "object" == o ? C(e, u, i, n) : e.add(n, u)
        })
    }
    ...
    t.ajax = function(e) {
        ...
        d(o),
        o.crossDomain || (s = n.createElement("a"),
        s.href = o.url,
        s.href = s.href,
        ...
        var f = o.dataType
          , h = /\?.+=\?/.test(o.url);
        if (h && (f = "jsonp"),
        o.cache !== !1 && (e && e.cache === !0 || "script" != f && "jsonp" != f) || (o.url = E(o.url, "_=" + Date.now())),
        "jsonp" == f)
            return h || (o.url = E(o.url, o.jsonp ? o.jsonp + "=?" : o.jsonp === !1 ? "" : "callback=?")),
            t.ajaxJSONP(o, a);
        var P, p = o.accepts[f], m = {}, x = function(t, e) {
            m[t.toLowerCase()] = [t, e]
        }, j = /^([\w-]+:)\/\//.test(o.url) ? RegExp.$1 : window.location.protocol, S = o.xhr(), C = S.setRequestHeader;
        if (a && a.promise(S),
        o.crossDomain || x("X-Requested-With", "XMLHttpRequest"),
        x("Accept", p || "*/*"),
        (p = o.mimeType || p) && (p.indexOf(",") > -1 && (p = p.split(",", 2)[0]),
        S.overrideMimeType && S.overrideMimeType(p)),
        (o.contentType || o.contentType !== !1 && o.data && "GET" != o.type.toUpperCase()) && x("Content-Type", o.contentType || "application/x-www-form-urlencoded"),
        o.headers)
            for (r in o.headers)
                x(r, o.headers[r]);
        ...
        S.onreadystatechange = function() {
            if (4 == S.readyState) {
                S.onreadystatechange = w,
                clearTimeout(P);
                var e, n = !1;
                if (S.status >= 200 && S.status < 300 || 304 == S.status || 0 == S.status && "file:" == j) {
                    f = f || b(o.mimeType || S.getResponseHeader("content-type")),
                    e = S.responseText;
                    try {
                        "script" == f ? (1,
                        eval)(e) : "xml" == f ? e = S.responseXML : "json" == f && (e = c.test(e) ? null : t.parseJSON(e))
                    } catch (i) {
                        n = i
                    }
                    n ? y(n, "parsererror", S, o, a) : v(e, S, o, a)
                } else
                    y(S.statusText || null, S.status ? "error" : "abort", S, o, a)
            }
        }
        ,
        g(S, o) === !1)
    ...
    t.fn.load = function(e, n, i) {
        if (!this.length)
            return this;
        var s, r = this, a = e.split(/\s/), u = j(e, n, i), f = u.success;
...
function(t) {
    ...
    t(document).ready(function() {
        ...
        t(document).bind("MSGestureEnd", function(t) {
            ...
            (!(x = p(i, "down")) || h(i)) && (y = x ? i : i.touches[0],
            ...
            e.last = d,
            o = setTimeout(f, a),
            s && x && s.addPointer(i.pointerId))
        }).on("touchmove MSPointerMove pointermove", function(t) {
            (!(x = p(t, "move")) || h(t)) && (y = x ? t : t.touches[0],
            c(),
            e.x2 = y.pageX,
            e.y2 = y.pageY,
...
function(t, e) {
    ...
    t.fn.anim = function(n, i, r, o, y) {
        var x, b, j, w = {}, E = "", T = this, S = t.fx.transitionEnd, C = !1;
        ...
        "string" == typeof n)
            ...
            b = [];
            for (x in n)
                a.test(x) ? E += x + "(" + n[x] + ") " : (w[x] = n[x],
                b.push(v(x)));
            E && (w[s] = E,
            b.push(s)),
            i > 0 && "object" == typeof n && (w[u] = b.join(", "),
            w[f] = i + "s",
            w[l] = y + "s",
            w[c] = r || "linear")
        }
